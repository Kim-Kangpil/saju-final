...
const LOADING_STEPS = [
  ...
  { upTo: 30, icon: "💼", msg: "직업과 연결된 오행 구조를 분석해요" },
  { upTo: 50, icon: "🎯", msg: "잘 맞는 직종과 일하는 방식을 파악해요" },
  { upTo: 68, icon: "📈", msg: "지금 커리어 흐름의 방향을 읽고 있어요" },
  { upTo: 83, icon: "🗓", msg: "올해 직업운의 타이밍을 계산해요" },
    ...
    return (
      <div style={{ maxWidth: 520, margin: "0 auto", background: "#F5F1EA", minHeight: "100vh", fontFamily: "'Gmarket Sans', sans-serif" }}>
        <header style={{ padding: "16px 20px", display: "flex", alignItems: "center", gap: 12, borderBottom: "1px solid #D4C9B8", background: "#fff" }}>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 700, color: "#2C2417", flex: 1 }}>🧭 직업운 분석</h1>
        </header>
