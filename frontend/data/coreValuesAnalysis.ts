...
const CORE_VALUES_TEMPLATE: Record<CoreValuesToneKey, string> = {
  empathy:
    "당신의 <strong>삶의 엔진</strong>은 {{branchName}}에서 가장 잘 드러납니다. 이 자리는 <strong>삶의 핵심적인 가치관과 지향점</strong>을 담는 자리예요. 타고난 기질이 ‘무엇을 우선순위로 두고 살아가느냐’를 보여주죠. {{branchName}}{{branchNameJosa}} <strong>{{keywords}}</strong> 쪽으로 끌리기 때문에, 일상의 선택과 방향 설정에서도 이 성향이 반복적으로 나타나곤 합니다.\n\n삶의 핵심적인 가치관과 지향점으로 보면, 일간 기준 월지는 ‘{{tenGod}}’에 해당하는 자리라 {{tenGodMeaning}}{{tenGodMeaningJosa}} <strong>핵심 가치</strong>로 두고 길을 선택하는 경향이 있습니다. 그래서 중요한 선택의 순간마다 머리로만 계산하기보다, 이 가치가 지켜지는지, 나다운 마음이 살아 있는지를 기준으로 방향을 정하는 사람이에요. 그런 점이 당신을 일관되게 이끄는 <strong>나침반</strong> 역할을 합니다.",
  reality:
    "당신의 <strong>삶의 엔진</strong>은 {{branchName}}에서 가장 잘 드러납니다. 이 자리는 <strong>삶의 핵심적인 가치관과 지향점</strong>을 담는 자리예요. 타고난 기질이 ‘무엇을 우선순위로 두고 살아가느냐’를 보여줍니다. {{branchName}}{{branchNameJosa}} <strong>{{keywords}}</strong> 쪽으로 끌리기 때문에, 일상의 선택과 방향 설정에서도 이 성향이 반복적으로 나타나는 구조예요.\n\n삶의 핵심적인 가치관과 지향점으로 보면, 일간 기준 월지는 ‘{{tenGod}}’에 해당하는 자리라 {{tenGodMeaning}}{{tenGodMeaningJosa}} <strong>핵심 가치</strong>로 두고 경로를 선택하는 경향이 있습니다. 따라서 중요한 선택 시점에는 해당 가치가 유지되는지, 자기 정체성이 살아 있는지를 기준으로 방향을 정하는 패턴을 보입니다. 이 구조가 <strong>의사결정의 일관성</strong>을 만드는 요인으로 작동합니다.",
  fun:
    "네 <strong>삶의 엔진</strong>은 {{branchName}}에서 제일 잘 드러나. 이 자리가 <strong>삶의 핵심적인 가치관과 지향점</strong>을 보여주는 자리라서, ‘뭘 우선으로 살아갈지’가 여기서 드러나. {{branchName}}{{branchNameJosa}} <strong>{{keywords}}</strong> 쪽으로 끌려서, 일상에서 선택할 때도 이 성향이 자꾸 나오는 편이야.\n\n삶의 핵심적인 가치관과 지향점으로 보면, 일간 기준 월지는 ‘{{tenGod}}’에 해당하는 자리라서 {{tenGodMeaning}}{{tenGodMeaningJosa}} <strong>핵심 가치</strong>로 두고 길 고르는 경향이 있어. 그래서 중요한 선택할 때마다 이 가치가 지켜지는지, 내 마음이 살아 있는지 보고 방향 정하는 타입이야. 그게 네 <strong>나침반</strong> 역할을 하는 거지.",
};
