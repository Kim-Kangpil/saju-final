...
export function getEmotionalWeaknessParagraph(
  ...
  if (tone === "fun") {
    introParts.push(
      "사람마다 마음이 흔들리는 지점은 달라. 사주에서는 그걸 성격 문제가 아니라 타고난 에너지랑 심리 구조로 보거든. 이 분석에서는 네 사주에서 감정이 예민하게 반응하기 쉬운 지점이랑 마음 부담이 커질 수 있는 상황을 살펴보는 거야."
    );
    ...
    introParts.push(
      "사람마다 마음이 흔들리는 지점은 다릅니다. 사주에서는 이런 반응을 성격 문제가 아니라 타고난 에너지와 심리 구조로 봅니다. 이 분석에서는 당신 사주에서 감정이 예민하게 반응하기 쉬운 지점과 마음 부담이 커질 수 있는 상황을 살펴봅니다."
    );
  }
