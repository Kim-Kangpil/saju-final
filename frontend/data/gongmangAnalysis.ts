  ...
  if (tone === "empathy" && dayStemForTenGod) {
    ...
    if (yearState === "none") {
      ...
      switch (yearGroup) {
        ...
        case "재성":
          middle =
            "재성 공망이 해공(공망이 해소됨)된 구조라, 집안 재정이 들쭉날쭉해 보여도 결국에는 기본 틀을 유지할 수 있는 흐름으로 귀결되기 쉽습니다.";
          break;
        case "관성":
          middle =
            "관성 공망이 해공(공망이 해소됨)되어, 부모의 기준에서 완전히 벗어나지는 않으면서도 스스로 선택할 수 있는 여지가 비교적 넓게 열려 있는 편이에요.";
          break;
        case "식상":
          middle =
        ...
        case "비겁":
          middle =
            "비겁 공망이 해공(공망이 해소됨)된 구조라, 형제·가족 간의 유대가 느슨하게만 흘러가지는 않고, 필요할 때 서로를 도와 줄 수 있는 선에서 관계가 유지되기 쉽습니다.";
          break;
        default:
          middle =
    ...
    if (monthState === "none") {
      ...
      switch (monthGroup) {
        case "관성":
          middle =
            "관성 공망이 해공(공망이 해소됨)된 구조라, 조직의 틀에서 완전히 이탈하기보다는 필요할 때는 안정적인 틀 안에, 필요할 때는 독립적으로 움직이는 유연성이 생기기 쉽습니다.";
          break;
        case "재성":
          middle =
        ...
        case "비겁":
          middle =
            "비겁 공망이 해공(공망이 해소됨)되어, 동료와의 관계가 완전히 끊기기보다는 느슨하지만 필요한 순간에는 힘을 모을 수 있는 형태로 유지되기 쉽습니다.";
          break;
        case "인성":
          middle =
            "인성 공망이 해공(공망이 해소됨)된 구조라, 조직의 보호를 과도하게 의존하지도, 완전히 고립되지도 않고, 스스로 길을 찾되 필요한 도움은 받을 수 있는 균형을 만들기 좋습니다.";
          break;
        default:
          middle =
    ...
    if (hourState === "none") {
      ...
      switch (hourGroup) {
        case "식상":
          middle =
            "식상 공망이 해공(공망이 해소됨)된 구조라, 자녀와의 관계가 완전히 끊기기보다는 각자의 삶을 존중하면서도 필요한 순간에는 가까워지는 형태로 유지되기 쉽습니다.";
          break;
        case "재성":
          middle =
        ...
        case "관성":
          middle =
            "관성 공망이 해공(공망이 해소됨)된 형태라, 말년에 사회적 역할에서 완전히 이탈하지는 않으면서도, 이전보다 훨씬 가벼운 책임감으로 자신의 시간을 구성할 수 있습니다.";
          break;
        case "인성":
          middle =
            "인성 공망이 해공(공망이 해소됨)되어, 혼자 있는 시간과 누군가와 함께하는 시간이 무게를 나눠 가지는 쪽으로 균형을 잡기 쉽습니다.";
          break;
        case "비겁":
          middle =
            "비겁 공망이 해공(공망이 해소됨)된 구조라, 관계를 과도하게 넓히기보다는, 오래 이어질 사람들과의 인연만 남기는 식으로 말년의 인간관계가 정리되기 쉽습니다.";
          break;
        default:
          middle =
