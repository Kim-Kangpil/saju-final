...
export function summarizeGuiin(
  ...
  if (tone === "fun") {
    introParts.push(
      "살다 보면 일이 술술 풀리거나 예상 못 한 도움이 찾아오는 때가 있지. 명리는 그걸 우연이 아니라, 삶 속에서 도움의 인연이 작동하는 구조로 봐. 사주에는 그런 인연이 들어올 수 있는 지점이 있고 그걸 귀인이라 부르는데, 이 분석에서는 네 사주에서 어떤 도움과 인연이 어떻게 작동하기 쉬운지 살펴보는 거야. 다만 귀인에 너무 크게 기대기보단, 삶 속에서 자연스럽게 이어지는 인연과 도움의 흐름 정도로 이해하는 게 더 현실적인 접근에 가까워."
    );
  } else if (tone === "reality") {
    introParts.push(
      "살다 보면 일이 잘 풀리거나 예상 밖의 도움이 들어오는 시기가 있습니다. 명리에서는 이를 우연이 아니라, 삶 속에서 도움의 인연이 작동하는 구조로 봅니다. 사주에는 그런 인연이 들어올 수 있는 지점이 있으며 이를 귀인이라고 부르고, 이 분석에서는 해당 사주에서 어떤 도움과 인연이 어떻게 작동하기 쉬운지를 살펴봅니다. 다만 귀인에 과도한 의미를 부여하기보다는, 삶 속에서 자연스럽게 이어지는 인연과 도움의 흐름 정도로 이해하는 편이 더 현실적인 접근에 가깝습니다."
    );
  } else {
    introParts.push(
      "살다 보면 일이 술술 풀리거나 예상 못 한 도움이 찾아오는 때가 있어요. 명리에서는 이런 흐름을 우연이 아니라, 삶 속에서 도움의 인연이 작동하는 구조로 봅니다. 사주에는 그런 인연이 들어올 수 있는 지점이 있고, 이를 귀인이라 부르며, 이 분석에서는 당신 사주에서 어떤 도움과 인연이 어떻게 작동하기 쉬운지 살펴봅니다. 다만 귀인에 너무 크게 의미를 두기보다는, 삶 속에서 자연스럽게 이어지는 인연과 도움의 흐름 정도로 이해하는 것이 더 현실적인 접근에 가깝습니다."
    );
  }
