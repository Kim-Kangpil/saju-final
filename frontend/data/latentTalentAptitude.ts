...
const APTITUDE_BODY: Record<string, { success: Record<AptitudeToneKey, string>; fail: Record<AptitudeToneKey, string> }> = {
  비견: {
    success: {
      empathy: "스스로 결단하고 자기 일을 끌어가는 힘이 분명히 드러나는 편이에요. 친구나 동료와 어울려도 흔들리지 않고, 혼자서도 맡은 일을 끝까지 해내는 타고난 추진력이 있어요. 독립적인 일, 자영업, 프리랜서처럼 자기 페이스로 움직이는 일에서 재능이 잘 발휘돼요. 주변에서도 당신만의 주체성과 끈기를 인정하기 쉬워요.",
      reality: "주체성과 추진력이 뚜렷하게 드러나는 편입니다. 독립·자영·프리랜서에 잘 맞고, 자기주도적으로 일할 때 좋은 성과가 나오기 쉽습니다.",
  ...
  겁재: {
    success: {
      empathy: "경쟁과 도전 속에서 빛나는 힘이 분명히 드러나는 편이에요. 승부욕이 당신을 앞으로 나아가게 하고, 새로운 일을 시작하거나 목표를 세우는 데 특별한 재능이 있어요. 영업, 스포츠, 경쟁이 있는 일처럼 ‘이기고 싶다’는 마음이 살아 있는 일에서 타고난 능력을 잘 쓸 수 있어요. 주변에서도 당신의 돌파력을 인정하기 쉬워요.",
      reality: "경쟁력과 승부욕이 뚜렷하게 드러나는 편입니다. 영업·경쟁·도전이 있는 일에 잘 맞고, 목표를 달성하는 데 강점이 있습니다.",
  ...
  식신: {
    success: {
      empathy: "말과 표현으로 빛나는 재능이 분명히 드러나는 편이에요. 생각과 욕구를 말로 잘 전달하고, 글쓰기·말하기·창작처럼 ‘밖으로 꺼내는’ 활동에서 특별한 힘이 있어요. 예술, 콘텐츠, 디자인, 교육처럼 재능을 사람들 앞에서 펼치는 일에 타고난 적성이 있어요. 주변에서도 당신의 창의성과 표현력을 인정하기 쉬워요.",
      reality: "표현력과 창의성이 뚜렷하게 드러나는 편입니다. 창작·예술·콘텐츠·교육 쪽에 잘 맞고, 좋은 성과가 나오기 쉽습니다.",
  ...
  상관: {
    success: {
      empathy: "기존 틀을 넘어서는 혁신과 비판적 시각이 분명히 드러나는 편이에요. 남들과 다른 아이디어로 문제를 풀거나, 새로운 방식을 만들어 내는 데 특별한 재능이 있어요. 스타트업, 연구·기획, 개혁처럼 ‘다르게 보는’ 일에서 타고난 능력을 잘 쓸 수 있어요. 주변에서도 당신의 독창성을 인정하기 쉬워요.",
      reality: "혁신성과 비판적 사고가 뚜렷하게 드러나는 편입니다. 스타트업·연구·기획·컨설팅에 잘 맞습니다.",
  ...
  편재: {
    success: {
      empathy: "움직이며 기회를 잡는 재능이 분명히 드러나는 편이에요. 사람을 만나고 관계를 넓히며 일을 추진하는 데 특별한 힘이 있어요. 사업, 영업, 유통처럼 활동적으로 움직이는 일에서 타고난 적성이 있어요. 주변에서도 당신의 사교성과 추진력을 인정하기 쉬워요.",
      reality: "사업 추진력과 네트워킹이 뚜렷하게 드러나는 편입니다. 영업·사업·유통에 잘 맞습니다.",
  ...
  정재: {
    success: {
      empathy: "꾸준히 쌓고 정리하는 재능이 분명히 드러나는 편이에요. 돈과 결과물을 다루는 감각이 있어, 일을 끝까지 마무리하고 관리하는 데 특별한 힘이 있어요. 회계, 재무, 자산관리처럼 안정적으로 쌓아가는 일에서 타고난 적성이 있어요. 주변에서도 당신의 현실감각과 끈기를 인정하기 쉬워요.",
      reality: "재무·관리 역량이 뚜렷하게 드러나는 편입니다. 회계·재무·자산관리 쪽에 잘 맞습니다.",
  ...
  편관: {
    success: {
      ...
      reality: "리더십과 의사결정력이 뚜렷하게 드러나는 편입니다. 경영·관리·임원급 일에 잘 맞습니다.",
  ...
  정관: {
    success: {
      empathy: "원칙과 책임을 지키며 조직에서 인정받는 재능이 분명히 드러나는 편이에요. 규칙을 지키고 맡은 일을 끝까지 하는 데 특별한 힘이 있어요. 공무원, 대기업, 공공·조직 일에서 타고난 적성이 있어요. 주변에서도 당신의 신뢰와 안정감을 인정하기 쉬워요.",
      reality: "조직 적응력과 책임감이 뚜렷하게 드러나는 편입니다. 공공·대기업·관리직에 잘 맞습니다.",
  ...
  편인: {
    success: {
      empathy: "깊은 사색과 독특한 시각이 분명히 드러나는 편이에요. 남들과 다른 길을 가더라도 당신만의 통찰이 세상에 필요한 사람이에요. 철학, 심리, 연구, 창작처럼 깊이 생각하는 일에서 타고난 재능이 있어요. 주변에서도 당신의 독창적인 관점을 인정하기 쉬워요.",
      reality: "통찰력과 독창적 사고가 뚜렷하게 드러나는 편입니다. 철학·심리·연구·집필 쪽에 잘 맞습니다.",
  ...
  정인: {
    success: {
      empathy: "배우고 가르치는 재능이 분명히 드러나는 편이에요. 지식을 쌓고 나누는 것을 좋아하며, 공부·문서·자격처럼 ‘나를 채워 주는’ 일에서 특별한 힘이 있어요. 교육, 연구, 강사, 멘토처럼 배움을 나누는 일에서 타고난 적성이 있어요. 주변에서도 당신의 학구열과 인내심을 인정하기 쉬워요.",
      reality: "학습·교육 역량이 뚜렷하게 드러나는 편입니다. 교육·연구·강사·학술 쪽에 잘 맞습니다.",
...
export function getLatentTalentAptitudeParagraph(
  ...
  if (tone === "empathy") {
    intro = info.touchu
      ? "당신이 태어난 달에 담긴 기운이 그대로 잘 드러나는 편이에요. "
      : "당신이 태어난 달에 담긴 기운이 아직 잘 드러나지 않는 편이에요. ";
  } else if (tone === "reality") {
    intro = info.touchu
      ? "태어난 달의 기운이 잘 드러나는 구조입니다. "
      : "태어난 달의 기운이 아직 잘 드러나지 않는 구조입니다. ";
  } else {
    intro = info.touchu
      ? "니가 태어난 달에 담긴 기운이 잘 드러나는 타입이야. "
      : "니가 태어난 달에 담긴 기운이 아직 잘 안 드러나는 타입이야. ";
  }
  ...
  const tail =
    tone === "empathy"
      ? "이 해석이 당신만의 재능과 잘 맞는 일을 알아가시는 데 조금이라도 도움이 되면 좋겠어요."
      : tone === "reality"
        ? "위 내용을 참고하여 재능을 발휘하고 잘 맞는 일을 찾아 보시면 됩니다."
        : "이거 참고해서 네한테 맞는 일 찾아 보면 좋겠어.";
  return text + " " + tail;
}
